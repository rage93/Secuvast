          ...
          <div className="overflow-hidden shadow sm:rounded-lg">
            <table className="min-w-full">
              ...
              <tbody className="bg-white dark:bg-gray-800">
                <tr>
                  <td className="rounded-l-lg p-4 text-base font-normal whitespace-nowrap text-gray-500 dark:text-gray-400">
                ...
                <tr className="bg-gray-50 dark:bg-gray-900">
                  <td className="p-4 text-base font-normal whitespace-nowrap text-gray-500 dark:text-gray-400">
                ...
                <tr className="bg-gray-50 dark:bg-gray-900">
                  ...
                  <td className="p-4">
                    <div className="flex items-center justify-end space-x-1">
                      ...
                      <span className="text-xs font-medium text-gray-900 sm:text-sm md:text-base dark:text-white">
                        1 User
                      </span>
                    </div>
                  </td>
